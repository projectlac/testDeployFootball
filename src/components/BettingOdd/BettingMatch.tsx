      ...
      <div className="mt-4">
        <div className="pl-2.5 py-1.5 border-l-4 border-secondary bg-[#edf2f7] flex items-center justify-between">
          <div className='flex'>
            ...
            <h3><Link className="text-primary hover:text-red text-sm font-bold" href={ROUTES.TOURNAMENT_BETTING_ODDS.replace(':id', bettingOdd.slug)}>
              {name}
            </Link></h3>
          </div>
          ...
          <div key={match[1].bet[0]?.id}>
            <div className="flex items-center text-sm py-1.5 border-b border-[#eee] last-of-type:border-b-0">
              ...
              <div className="w-[calc(100%-300px)]">
                <div className="w-1/2 py-2 flex justify-start gap-1">
