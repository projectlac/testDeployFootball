...
//       dispatch(fetchMetaData({ type: 'results', slug: slug, url: location.pathname }))
//     } catch (error) {
//       console.log(error)
//     }
//   }
...
//             <span key={number}>
//               {day === number ? (
//                 <span className="px-3 py-1 bg-secondary rounded text-primary  hover:cursor-pointer text-sm mr-2">{getPrevDate(number)}</span>
//               ) : (
//                 <span
